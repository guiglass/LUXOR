 ...
 * Adds auto-mapped <a href="img/visemeLinker.png">VisemeLinker</a> (lipsync) and a <a href="img/facecapLinker.png">FacecapLinker</a> using predefined templates for some avatrar types. 
